using ApiProjeKampi.WebUl.Dtos.FeatureDtos;
...
namespace ApiProjeKampi.WebUl.Controllers
{
    public class FeatureController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.DeleteAsync("https://localhost:7003/api/Features?id=" + id);
            return RedirectToAction("FeatureList");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7003/api/Features/GetFeature?id=" + id);
            var jsonData = await responseMessage.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> UpdateFeature(UpdateFeatureDto updateFeatureDto)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            await client.PutAsync("https://localhost:7003/api/Features/", stringContent);
            return RedirectToAction("FeatureList");
        }
    }
}
